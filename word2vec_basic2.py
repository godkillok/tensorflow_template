...
def maybe_download(filename, expected_bytes):
  ...
  local_filename = os.path.join('C:/Users/TangGuoping/Downloads/', filename)
...
def generate_batch2(i):
  ...
  all_lines = [v for v in sql_result]
      ...
      for d2 in data:
        if d1!=d2:
          ...
          example = tf.train.Example(features=tf.train.Features(feature={
            ...
            "values": tf.train.Feature(float_list=tf.train.Int64List(value=[values]))
          }))
